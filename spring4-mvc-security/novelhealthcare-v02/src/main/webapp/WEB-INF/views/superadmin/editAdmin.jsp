			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form:form id="registration-form" action="./updateAdmin" commandName="adminBean" method="POST" role="form" style="display: block;">
									<div class="form-group">
										<form:select path="hospitalName">
											<form:option value="${adminBean.hospitalName}">${adminBean.hospitalName}</form:option>
											<form:options items="${hospitalNameList}"/>
										</form:select>
									</div>
									<div class="form-group">
										<form:input path="adminId" type="hidden"  id="hospitalId" tabindex="1" class="form-control" placeholder="HospitalId" value="" ></form:input>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<c:if test="${adminBean.status == true}">
										...
										<c:if test="${adminBean.status == false}">
