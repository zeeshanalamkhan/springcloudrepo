			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form:form id="registration-form" action="./addDoctor" commandName="doctorBean"  method="POST" >
				                        ...
				                        <div class="row">
				                            <div class="col-md-9">
				                                ...
				                                <div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            <label class="control-label"><label for="Doctor_FirstName">First Name</label><span class="required">*</span></label>
				                                    ...
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            <label class="control-label"><label for="Doctor_MiddleName">Middle Name</label>
				                                    ...
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            <label class="control-label"><label for="Doctor_LastName">Last Name</label><span class="required">*</span></label>
				                                ...
				                                <div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            <label class="control-label"><label for="Doctor_Phone">Phone Number</label><span class="required">*</span></label>
				                                            <form:input class="form-control" path="phoneNumber" type="text" value=""/>
				                                            <span class="field-validation-valid" data-valmsg-for="User.Phone" data-valmsg-replace="true"></span>
				                                        </div>
				                                    </div>
				                                    <div class="col-md-4">
				                                        <div class="form-group">
															<label class="control-label"><label for="Doctor_Email">Email (User Name)</label> <span class="required">*</span></label>
													...
													<div class="col-md-4">
				                                        <div class="form-group">
															<label class="control-label"><label for="Doctor_Password">Password</label> <span class="required">*</span></label>
