...
$("#deleteId").click(function(){ // Click to only happen on announce links
    ...
    <div class="container-fluid display-table">
        ...
        <div class="table-responsive">
    		...
    		<tbody>
				...
				<tr>
				<td id="docid">${docbean.getDocId()}</td>
				<td>${docbean.getDocName()}</td>
				<td>${docbean.getEmail()}</td>
				<td>${docbean.getGender()}</td>

				<td><p data-placement="top" data-toggle="tooltip" title="Delete"><button id="deleteId" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Record?</div>
        ...
        <div class="modal-footer ">
        <a href="deleteDoctorById?docId=${docbean.getDocId()}" type="button" class="btn btn-success" ><span class="glyphicon glyphicon-ok-sign"></span> Yes</a>
