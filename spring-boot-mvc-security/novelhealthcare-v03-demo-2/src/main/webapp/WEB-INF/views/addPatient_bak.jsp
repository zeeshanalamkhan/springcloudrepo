...
<div class="container">
    ...
    <div class="col-md-8">
      ...
      <!--   <hr> -->
            <form:form action="savePatientdetails" commandName="patientBean" method="POST" name="signupPatient" onsubmit="return signup()" class="form-horizontal"  id="signup">
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <form:input path="mobilenumber" class="form-control"  id="contactnum" placeholder="Enter your Primary contact no." value=""></form:input>
